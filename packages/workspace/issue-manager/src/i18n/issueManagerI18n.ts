...
const issueManagerEn = {
  actions: {
    ...
    acceptTask: "Accept",
    askAgentToBreakdown: "Fill breakdown prompt",
    askAgentToRun: "Fill agent prompt",
    cancel: "Cancel",
    clearSearch: "Clear search",
    closeTaskDetails: "Back to issue details",
...
const issueManagerZhCN = {
  actions: {
    ...
    addSubtask: "添加子事项",
    acceptTask: "验证通过",
    askAgentToBreakdown: "填入拆解提示",
    askAgentToRun: "填入 Agent",
    cancel: "取消",
    clearSearch: "清空搜索",
    closeTaskDetails: "返回事项详情",
